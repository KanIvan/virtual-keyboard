const Keyboard = {
    ...
    init() {
        ...
        this.elements.text.classList.add("textarea_style");
        document.body.appendChild(this.elements.text);

        this.elements.main = document.createElement("div");
        this.elements.keysContainer = document.createElement("div");

        this.elements.main.classList.add("keyboard", "1keyboard--hiden");
            ...
            switch (key) {
                ...
                case "caps":
                    ...
                    keyElement.addEventListener("click", () => {
                        ...
                        keyElement.classList.toggle("keyboard__key--active", this.properties.capsock);
                    });
